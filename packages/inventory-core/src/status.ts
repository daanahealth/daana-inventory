 ...
 */
export const allowedTransitions: Readonly<Record<ItemStatus, readonly ItemStatus[]>> = {
  active: ["in_cart", "pending_approval", "checked_out", "removed", "expired"],
 ...
 */
export function isActiveStatus(s: ItemStatus): boolean {
 ...
 */
export function isTerminalStatus(s: ItemStatus): boolean {
 ...
 */
export function isSearchableForRestrictedUser(s: ItemStatus): boolean {
  return s === "active";
}
